...
MediaPlayer.rules.DisplaySizeRule = function() {
    "use strict";
    var isMobile, lastSwitchTime = 0, waitToSwitchTime = 1500, maxWidth = 800, maxHeight = 600, testMobile = function() {
    ...
    return {
        ...
        execute: function(context, callback) {
            ...
            var elementWidth = this.videoModel.getElement().offsetWidth || 0, elementHeight = this.videoModel.getElement().offsetHeight || 0;
